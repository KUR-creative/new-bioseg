...
%function [idx, dist, k, classified] = fastKNN(trained, unknown, k, distance)
%function [idx, dist] = fastKNN(trained, unknown, k, distance)
%function [idx, dist] = knnsearch(trained, unknown, k, distance)
function [classified, k, dist, idx] = knnsearch(trained, unknown, k, distance)
